...
class AppPreferencesImpl(
    ...
    override fun observeIsDisclaimerAccepted() = dataStore.data.map { prefs ->
    ...
    override fun observeThemeMode() = dataStore.data.map { prefs ->
    ...
    override fun observeColorScheme() = dataStore.data.map { prefs ->
    ...
    override fun observeArePrivateActivitiesHidden() = dataStore.data.map {
        it[HIDE_PRIVATE_ACTIVITIES_KEY] ?: false
    }
